...
```
> curl -XPOST -H "Content-Type: application/json" localhost:9000/br.com.restaurant.product-registration-backend.MyServiceEntity/GetValue -d '{"entityId": "foo"}'
...
```shell
> grpcurl -plaintext -d '{"entityId": "foo"}' localhost:9000 br.com.restaurant.product-registration-backend.MyServiceEntity/GetValue
ERROR:
  Code: Unknown
